    ...
    <form action="{{route('create.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col align-self-center">
            ...
            <div class="form-group item">
                ...
                <input type="date" class="form-control" id="dtd" name="startdate" placeholder="Start Date"/>
            ...
            <div class="form-group">
                ...
                <select class="form-control " aria-label=".form-select-lg " name="game">
                    <option selected></option>
                    <option value="1">Valorant</option>
                    <option value="3">COD Warzone -- PC</option>
                    <option value="4">COD Warzone -- PS4</option>
                    <option value="5">COD Warzone -- XBOX</option>
